class StockMarket{
	...
	static String stockMarkets[] = {"Reliance Industries","Tata Consultancy Services","Infosys","HDFC Bank","ICICI Bank","Hindustan Unilever","State Bank of India","Bharti Airtel","ITC Limited","Larsen & Toubro"};
